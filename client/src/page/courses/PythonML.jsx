...
// ----------- course pdf -----------------
import AI_Machine_Learning_With_Python from "../../assets/Course_pdf/AI_Machine_Learning_With_Python.pdf";

import Card1 from "../../img/card1.png";
import ToggleModule from "../../components/ToggleModule";
import { PythonML_faqs } from "../../constants/courses_faqs";
...
const PythonML = () => {
  ...
  return (
    <>
      ...
      <div className="bg-center bg-cover relative z-0 bg_PythonML"></div>
        <div className="my-5 p-4 md:p-15">
          <div>
            <p className="uppercase text-xl md:text-3xl font-semibold ">
              AI and ML  <span className="text-green-600">with Python{" "} </span>
            ...
            <div className="flex flex-col md:flex-row my-10">
              ...
              <div className="basis-full md:basis-3/5 p-2 md:p-1 text-slate-800 text-[16px] md:text-[18px]">
                ...
                <a href={AI_Machine_Learning_With_Python} download="Example-PDF-document"  target="_blank" rel="noreferrer" className={commonButtonClasses}>
                ...
                <div className="mt-10 ">
                  ...
                  <ToggleModule faqs={PythonML_faqs} />
                </div>
              </div>
