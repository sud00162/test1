...
import Cloud_Networking_Engineer_Course from '../../assets/Course_pdf/Cloud_Networking_Engineer_Course.pdf'

import Card1 from "../../img/card1.png";
import ToggleModule from "../../components/ToggleModule";
import {MultiCloudNetworking_faqs} from '../../constants/courses_faqs'
...
const MultiCloudNetworking = () => {
  ...
  return (
    <>
      ...
      <div className="bg-center bg-cover relative z-0 bg_Multi_Cloud_Networking"></div>
            ...
            <div className="flex flex-col md:flex-row my-10">
              ...
              <div className="basis-full md:basis-3/5 p-2 md:p-5 text-slate-800 text-[16px] md:text-[18px]">
                ...
                <div className="mt-10 ">
                  ...
                  <ToggleModule faqs={MultiCloudNetworking_faqs} />
                </div>
              </div>
